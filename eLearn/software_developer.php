...
$sqlCertifications = "SELECT CertificationID, CertificationName, certification_url FROM Certifications WHERE FieldID=1";
$resultCertifications = $conn->query($sqlCertifications);

// SQL query to fetch data from the Courses table
$sqlCourses = "SELECT CourseID, CourseName, Provider, URL, IsFree, Duration FROM Courses WHERE FieldID=1";
...
<h1 class="heading">Software Development</h1>
<div class="super_container">
    <div style="margin-left:11%; margin-right:11%;margin-bottom:5%;">
        ...
        <div id="roadmap" class="container roadmap">
            <h1>Roadmap</h1>
            <img src="images/software-developer.jpg" style="display: block;margin: 0 auto 20px auto;border: 5px solid orange;border-radius: 10px;max-width: 100%;"> 
        </div>
